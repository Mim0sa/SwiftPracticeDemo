...
@objc(Book_Sources_PageTwoViewController)
public class PageTwoViewController: UIViewController, PlaygroundLiveViewMessageHandler, PlaygroundLiveViewSafeAreaContainer, CAAnimationDelegate {
...
//        launch()
    ...
    func filterImage(imageView: UIImageView, filteredImage: UIImage) {
        ...
        UIView.animate(withDuration: 5, animations: {
            ...
            PlaygroundPage.current.assessmentStatus = .pass(message: "Great job! And you can also try another combination.")
        }
    }
    
}

extension PageTwoViewController {
...
extension PageTwoViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
